...
var startGame = function() {
    ...
    for(var i = 0; i < enemyInfo.length; i++) {
        if (playerInfo.health > 0) {
            ...
            // pick new enemy to fight based on the index of the enemy.names arrary
...
var shop = function() {
    ...
    var shopOptionPrompt = window.prompt(
        "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter one: '1' to refill health, '2' to upgrade, or '3' to leave."
    );
